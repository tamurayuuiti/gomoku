    ...
    case 'Playing':
      return (
        <span className="flex items-center gap-2">
          <span className="text-xs font-semibold uppercase tracking-widest text-slate-400 dark:text-zinc-500 sm:text-sm">手番</span>
          ...
          {gameMode === 'PvE' && (
            <span className="text-xs font-semibold text-slate-400 dark:text-zinc-500 sm:text-sm">
