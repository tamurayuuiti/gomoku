...
const Cell = ({ value, onClick, isLastMove, isHoshi, row, col, boardSize }: CellProps) => {
  // 線の表示条件
  const isTop = row === 0;
  ...
  return (
    <div
      className="relative flex aspect-square cursor-pointer items-center justify-center sm:h-auto"
      onClick={onClick}
    >
      {/* 十字線の描画ロジック */}
